...
//       try {
//         const token = localStorage.getItem("authToken");
//         const response = await fetch(`http://localhost:8000/doctors/${doctorId}/appointments`, {
//           method: "GET",
//           headers: {
...
// const userResponse = await fetch("http://localhost:8000/patient/get-user-details", {
//   method: "GET",
//   headers: {
...
//       const token = localStorage.getItem("authToken");
//       const response = await fetch("http://localhost:8000/doctors/bookAppointment", {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//           Authorization: token,
...
//         await fetch("http://localhost:8000/patient/send-confirmation-mail", {
//           method: "POST",
//           headers: {
//             "Content-Type": "application/json",
...
//     try {
//       const token = localStorage.getItem("authToken");
//       const response = await fetch("http://localhost:8000/patient/send-confirmation-mail", {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//           "Authorization": `Bearer ${token}`,
...
const handleSlotClick = (slot) => {
  ...
  const fetchBookedAppointments = async () => {
    try {
      const token = localStorage.getItem("authToken");
      const response = await fetch(`http://localhost:8000/doctors/${doctorId}/appointments?date=${selectedDate}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`,
