...
//           >
//             <div className="w-12 h-12 flex items-center justify-center bg-white border-2 border-green-500 rounded-full shadow-md hover:shadow-lg transition">
//               <img src={part.image} alt={part.name} className="w-6 h-7" />
//             </div>
//             <p className="text-green-800 mt-1 font-semibold">{part.name}</p>
//           </div>
//         ))}
//       </div>
//     </div>
