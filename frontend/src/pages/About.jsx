...
//       <div className="md:my-12 my-6 flex flex-col md:flex-row gap-8 items-center">
//         <img
//           className="w-full md:max-w-[400px] rounded-lg shadow-lg transform transition duration-300 hover:scale-105"
//           src={assets.about_image || "/placeholder.svg"}
//           alt="About Us"
//         />
//         <div className="flex flex-col justify-center gap-4 md:gap-6 w-full md:w-2/4 text-md text-gray-700 leading-relaxed">
//           <p className="border-l-4 border-green-400 pl-3 md:pl-4">
